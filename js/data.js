...
const CATEGORIES = [
  { id:'wrc',         name:'WRC',               group:'Rally',
    platforms:['rallytv_m','rallytv_a','rallytv_m_jp','rallytv_a_jp','itvx','servustv','acestrlms','pitsport','rbtv77'] },
  { id:'erx',         name:'World RX',           group:'Rally',
    platforms:['erx_yt','rx_plus','rallytv_m','rallytv_a','acestrlms'] },

  { id:'f1',          name:'Formula 1',          group:'Fórmula',
    platforms:['dp_std','dp_prem','f1tv_m','f1tv_a','skysports','canalplus','espnplus','viaplay','srf','rtbf','servustv','orf','band','acestrlms','pitsport','rbtv77'] },
  { id:'f2',          name:'Formula 2',          group:'Fórmula',
    platforms:['dp_std','dp_prem','f1tv_m','f1tv_a','skysports','canalplus','espnplus','viaplay','srf','rtbf','servustv','orf','band','acestrlms','pitsport','rbtv77'] },
  { id:'f3',          name:'Formula 3',          group:'Fórmula',
    platforms:['dp_std','dp_prem','f1tv_m','f1tv_a','skysports','canalplus','espnplus','viaplay','srf','rtbf','servustv','orf','band','acestrlms','pitsport','rbtv77'] },
  { id:'f4ita',       name:'Italian F4',         group:'Fórmula',
    platforms:['f4ita_yt','motorsporttv_f','acestrlms'] },
  { id:'indynxt',     name:'IndyNXT',            group:'Fórmula',
    platforms:['indycar_m','indycar_s','peacock_p','acestrlms','pitsport','rbtv77'] },
  { id:'superf',      name:'Super Formula',      group:'Fórmula',
    platforms:['sfgo_m','sfgo_a','msptv_m','abema','jsports','acestrlms'] },
  { id:'indycar',     name:'IndyCar',            group:'Fórmula',
    platforms:['dp_prem','espn_ar','indycar_s','peacock_p','youtubetv','sling','hulu_live','fubotv','tsn','skysports','skysport_de','skysport_it','motorvision_p','movistar_p','viaplay','ziggo_sport','canalplus','gaora','sporttv_pt','stan_basic','skynz','voosport','ssport','network4','tvcultura','ninenetwork','acestrlms','pitsport','rbtv77'] },
  ...
  { id:'wec',         name:'WEC',                group:'Resistencia',
    platforms:['max_std','fiawec_r','fiawec_s','fiawec_le','tntsports','band','lequipe','somos_fox','acestrlms'] },
  { id:'imsa',        name:'IMSA',               group:'Resistencia',
    platforms:['imsatv','peacock_p','peacock_pp','acestrlms','pitsport','rbtv77'] },
  { id:'elms',        name:'ELMS',               group:'Resistencia',
    platforms:['elms_yt','motorsporttv_f','acestrlms'] },
  { id:'alms',        name:'ALMS',               group:'Resistencia',
    platforms:['alms_yt','motorsporttv_f','acestrlms'] },
  { id:'nls',         name:'NLS / N24',           group:'Resistencia',
    platforms:['nurb_yt','acestrlms'] },
  { id:'ewc',         name:'FIM EWC',             group:'Resistencia',
    platforms:['max_std','jsports','acestrlms'] },

  { id:'gulf12',      name:'Gulf 12 Hours',       group:'Resistencia',
    platforms:['gtworld_yt','motorsporttv_f','acestrlms'] },

  { id:'motogp',      name:'MotoGP',             group:'Motos',
    platforms:['dp_std','dp_prem','vp_moto_s','vp_moto_t','tntsports','dazn_motor','skysports','canalplus','servustv','max_std','rtbf','srf','acestrlms','pitsport','rbtv77'] },
  { id:'moto2',       name:'Moto2',              group:'Motos',
    platforms:['dp_std','dp_prem','vp_moto_s','vp_moto_t','tntsports','dazn_motor','skysports','canalplus','servustv','max_std','rtbf','srf','acestrlms','pitsport','rbtv77'] },
  { id:'moto3',       name:'Moto3',              group:'Motos',
    platforms:['dp_std','dp_prem','vp_moto_s','vp_moto_t','tntsports','dazn_motor','skysports','canalplus','servustv','max_std','rtbf','srf','acestrlms','pitsport','rbtv77'] },
  { id:'wsbk',        name:'World SBK',          group:'Motos',
    platforms:['dp_std','dp_prem','vp_sbk','tntsports','rtve','servustv','acestrlms'] },
  { id:'iomtt',       name:'Isle of Man TT',      group:'Motos',
    platforms:['ttplus','itvx','acestrlms'] },

  { id:'gtworld',     name:'GT World Tour',       group:'GTs',
    platforms:['gtworld_yt','skysports','kayo_std','jsports','rtbf','acestrlms'] },
  ...
  { id:'adac',        name:'ADAC GT Masters',     group:'GTs',
    platforms:['adac_yt','rande','servustv','acestrlms'] },
  { id:'dtm',         name:'DTM',                group:'GTs',
    platforms:['dtm_yt','rande','servustv','viaplay','msptv_m','acestrlms'] },

  { id:'nascar_cup',  name:'NASCAR Cup',         group:'Stock Cars',
    platforms:['sling','youtubetv','tntsports','band','somos_fox','acestrlms','pitsport','rbtv77'] },
  { id:'nascar_truck',name:'NASCAR Truck',        group:'Stock Cars',
    platforms:['sling','youtubetv','floracing','somos_fox','acestrlms','pitsport','rbtv77'] },
  { id:'nascar_or',   name:"NASCAR O'Reilly",     group:'Stock Cars',
    platforms:['cwnetwork','somos_fox','acestrlms','pitsport','rbtv77'] },
  ...
  { id:'stock',       name:'Stock Car Brasil',    group:'Stock Cars',
    platforms:['stockcar_yt','globoplay','band','acestrlms'] },
  ...
  { id:'supercars',   name:'Supercars',          group:'Touring Cars',
    platforms:['superview','supercars_yt','kayo_std','kayo_prem','skynz','tntsports','acestrlms'] },
  { id:'btcc',        name:'BTCC',               group:'Touring Cars',
    platforms:['btcc_yt','itvsport_yt','itvx','tiktok','msptv_m','acestrlms'] },
  ...
  { id:'tcr_world',   name:'TCR World Tour',      group:'Touring Cars',
    platforms:['tcrtv_yt','tcrtv_vip','acestrlms'] },
  { id:'tcr_eu',      name:'TCR Europe',          group:'Touring Cars',
    platforms:['tcrtv_yt','tcrtv_vip','acestrlms'] },
  { id:'tcr_am',      name:'TCR America',         group:'Touring Cars',
    platforms:['tcrtv_yt','motorsporttv_f','speedtour_tv','acestrlms'] },
  { id:'btrc',        name:'British Truck Racing', group:'Touring Cars',
    platforms:['btrc_yt','motorsporttv_f','tiktok','acestrlms'] },

  { id:'fdrift',      name:'Formula Drift',       group:'Drift',
    platforms:['fdrift_yt','floracing','acestrlms'] },
