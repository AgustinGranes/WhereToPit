...
const PLATFORMS = {
  ...
  f4ita_yt:      { name:'Italian F4 YouTube',  type:'Gratis (YouTube)',       url:'https://www.youtube.com/@ItalianF4Championship' },
  ...
  bath_yt:       { name:'Bathurst YouTube',    type:'Gratis (YouTube)',       url:'https://www.youtube.com' },
  btrc_yt:       { name:'BTRC YouTube',        type:'Gratis (YouTube)',       url:'https://www.youtube.com/@btrc' },
  ...
  supercars_yt:  { name:'Supercars YT Membresía',     type:'Pago', price:5.99,     cur:'USD', url:'https://www.youtube.com/@supercars' },
...
const CATEGORIES = [
  { id:'wrc',         name:'WRC',               group:'Rally',
    platforms:['rallytv_m','rallytv_a','itvx','redbulltv','servustv','acestrlms','rbtv77'] },
  ...
  { id:'f1',          name:'Formula 1',          group:'Fórmula',
    platforms:['dp_std','dp_prem','f1tv_m','f1tv_a','skysports','canalplus','espnplus','viaplay','srf','rtbf','servustv','orf','band','acestrlms','rbtv77'] },
  ...
  { id:'indynxt',     name:'IndyNXT',            group:'Fórmula',
    platforms:['indycar_m','indycar_s','peacock_p','acestrlms','rbtv77'] },
  ...
  { id:'wec',         name:'WEC',                group:'Resistencia',
    platforms:['max_std','fiawec_r','fiawec_s','fiawec_le','tntsports','band','lequipe','acestrlms','rbtv77'] },
  { id:'imsa',        name:'IMSA',               group:'Resistencia',
    platforms:['imsatv','peacock_p','peacock_pp','acestrlms','rbtv77'] },
  ...
  { id:'bath6h',      name:'Bathurst 6 Hours',   group:'Resistencia',
    platforms:['bath_yt','stan_basic','stan_std','stan_prem','acestrlms','rbtv77'] },
  ...
  { id:'motogp',      name:'MotoGP',             group:'Motos',
    platforms:['dp_std','dp_prem','vp_moto_s','vp_moto_t','tntsports','dazn_motor','skysports','canalplus','servustv','max_std','rtbf','srf','acestrlms','rbtv77'] },
  ...
  { id:'nascar_cup',  name:'NASCAR Cup',         group:'Stock Cars',
    platforms:['sling','youtubetv','tntsports','band','somos_fox','acestrlms','rbtv77'] },
  { id:'nascar_truck',name:'NASCAR Truck',        group:'Stock Cars',
    platforms:['sling','youtubetv','floracing','somos_fox','acestrlms','rbtv77'] },
  { id:'nascar_or',   name:"NASCAR O'Reilly",     group:'Stock Cars',
    platforms:['cwnetwork','somos_fox','acestrlms','rbtv77'] },
  ...
  { id:'btcc',        name:'BTCC',               group:'Touring Cars',
    platforms:['btcc_yt','itvx','tiktok','msptv_m','acestrlms','rbtv77'] },
