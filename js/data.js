...
const CATEGORIES = [
  ...
  { id:'wec',         name:'WEC',                group:'Resistencia',
    platforms:['fiawec_s','eurosport_max_eu','tntsports','discovery_plus_uk','jsports','msptv_m','somos_fox','acestrlms'] },
  ...
  { id:'nascar_cup',  name:'NASCAR Cup',         group:'Stock Cars',
    platforms:['dp_prem','sling','youtubetv','prime_video_usa','max_std','discovery_plus_uk','acestrlms','pitsport','rbtv77'] },
  { id:'nascar_truck',name:'NASCAR Truck',        group:'Stock Cars',
    platforms:['sling','youtubetv','acestrlms','pitsport','rbtv77'] },
  { id:'nascar_or',   name:"NASCAR O'Reilly",     group:'Stock Cars',
    platforms:['the_cw_app','somos_fox','acestrlms','pitsport','rbtv77'] },
