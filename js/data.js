...
const CATEGORIES = [
  ...
  { id:'indynxt',     name:'IndyNXT',            group:'Fórmula',
    platforms:['dp_prem','indycar_s','fox_usa','bandsports_br','movistar_p','sling','youtubetv','tsn','acestrlms','pitsport','rbtv77'] },
  { id:'superf',      name:'Super Formula',      group:'Fórmula',
    platforms:['sfgo_m','jsports','acestrlms'] },
  { id:'indycar',     name:'IndyCar',            group:'Fórmula',
    platforms:['dp_prem','peacock_p','fox_usa','bandsports_br','sling','youtubetv','hulu_live','fubotv','tsn','skysports','skysport_de','skysport_it','motorvision_p','movistar_p','viaplay','ziggo_sport','canalplus','gaora','sporttv_pt','stan_basic','skynz','voosport','ssport','network4','tvcultura','ninenetwork','espn_ar','acestrlms','pitsport','rbtv77'] },
